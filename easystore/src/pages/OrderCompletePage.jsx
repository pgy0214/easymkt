    ...
    <div className="mx-auto max-w-md px-4 py-6">
      ...
      <div className="mb-4 rounded-card border border-brand-200 bg-brand-50 p-4">
        ...
        {!error && bankInfo && !bankReady && (
          <p className="text-sm text-gray-500">입금계좌가 아직 등록되지 않았습니다. 관리자에게 문의해주세요.</p>
        )}
        {bankReady && (
      ...
      <button onClick={() => navigate('/')} className="w-full rounded-btn border border-gray-300 py-3 text-sm text-gray-600 hover:bg-gray-50">
        목록으로
      </button>
    </div>
  )
